...
impl ContextTagKeysBuilder {
    ...
    pub fn application_version(&mut self, application_version: Option<String>) -> &mut Self {
    ...
    pub fn device_locale(&mut self, device_locale: Option<String>) -> &mut Self {
    ...
    pub fn device_model(&mut self, device_model: Option<String>) -> &mut Self {
        self.device_model = device_model;
        self
    }

    /// Sets: Client device OEM name taken from the browser.
    pub fn device_oem_name(&mut self, device_oem_name: Option<String>) -> &mut Self {
    ...
    pub fn device_os_version(&mut self, device_os_version: Option<String>) -> &mut Self {
    ...
    pub fn device_type(&mut self, device_type: Option<String>) -> &mut Self {
    ...
    pub fn location_ip(&mut self, location_ip: Option<String>) -> &mut Self {
    ...
    pub fn location_country(&mut self, location_country: Option<String>) -> &mut Self {
        self.location_country = location_country;
        self
    }

    /// Sets: The province/state of the client device. If any of Country, Province, or City is specified, those values will be preferred over geolocation of the IP address field. Information in the location context fields is always about the end user. When telemetry is sent from a service, the location context is about the user that initiated the operation in the service.
    pub fn location_province(&mut self, location_province: Option<String>) -> &mut Self {
        self.location_province = location_province;
        self
    }

    /// Sets: The city of the client device. If any of Country, Province, or City is specified, those values will be preferred over geolocation of the IP address field. Information in the location context fields is always about the end user. When telemetry is sent from a service, the location context is about the user that initiated the operation in the service.
    pub fn location_city(&mut self, location_city: Option<String>) -> &mut Self {
    ...
    pub fn operation_id(&mut self, operation_id: Option<String>) -> &mut Self {
    ...
    pub fn operation_name(&mut self, operation_name: Option<String>) -> &mut Self {
        self.operation_name = operation_name;
        self
    }

    /// Sets: The unique identifier of the telemetry item's immediate parent.
    pub fn operation_parent_id(&mut self, operation_parent_id: Option<String>) -> &mut Self {
    ...
    pub fn operation_synthetic_source(&mut self, operation_synthetic_source: Option<String>) -> &mut Self {
    ...
    pub fn operation_correlation_vector(&mut self, operation_correlation_vector: Option<String>) -> &mut Self {
    ...
    pub fn session_id(&mut self, session_id: Option<String>) -> &mut Self {
        self.session_id = session_id;
        self
    }

    /// Sets: Boolean value indicating whether the session identified by ai.session.id is first for the user or not.
    pub fn session_is_first(&mut self, session_is_first: Option<String>) -> &mut Self {
    ...
    pub fn user_account_id(&mut self, user_account_id: Option<String>) -> &mut Self {
    ...
    pub fn user_id(&mut self, user_id: Option<String>) -> &mut Self {
    ...
    pub fn user_auth_user_id(&mut self, user_auth_user_id: Option<String>) -> &mut Self {
    ...
    pub fn cloud_role(&mut self, cloud_role: Option<String>) -> &mut Self {
        self.cloud_role = cloud_role;
        self
    }

    pub fn cloud_role_ver(&mut self, cloud_role_ver: Option<String>) -> &mut Self {
    ...
    pub fn cloud_role_instance(&mut self, cloud_role_instance: Option<String>) -> &mut Self {
        self.cloud_role_instance = cloud_role_instance;
        self
    }

    pub fn cloud_location(&mut self, cloud_location: Option<String>) -> &mut Self {
    ...
    pub fn internal_sdk_version(&mut self, internal_sdk_version: Option<String>) -> &mut Self {
    ...
    pub fn internal_agent_version(&mut self, internal_agent_version: Option<String>) -> &mut Self {
    ...
    pub fn internal_node_name(&mut self, internal_node_name: Option<String>) -> &mut Self {
