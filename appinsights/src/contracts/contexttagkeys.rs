...
impl ContextTagKeysBuilder {
    ...
    pub fn device_locale(&mut self, device_locale: impl Into<String>) -> &mut Self {
        self.device_locale = Some(device_locale.into());
        self
    }
    ...
    pub fn device_model(&mut self, device_model: impl Into<String>) -> &mut Self {
        self.device_model = Some(device_model.into());
        self
    }

    /// Sets: Client device OEM name taken from the browser.
    pub fn device_oem_name(&mut self, device_oem_name: impl Into<String>) -> &mut Self {
        self.device_oem_name = Some(device_oem_name.into());
        self
    }
    ...
    pub fn device_os_version(&mut self, device_os_version: impl Into<String>) -> &mut Self {
        self.device_os_version = Some(device_os_version.into());
        self
    }
    ...
    pub fn device_type(&mut self, device_type: impl Into<String>) -> &mut Self {
    ...
    pub fn location_ip(&mut self, location_ip: impl Into<String>) -> &mut Self {
        self.location_ip = Some(location_ip.into());
        self
    }
    ...
    pub fn location_country(&mut self, location_country: impl Into<String>) -> &mut Self {
        self.location_country = Some(location_country.into());
        self
    }

    /// Sets: The province/state of the client device. If any of Country, Province, or City is specified, those values will be preferred over geolocation of the IP address field. Information in the location context fields is always about the end user. When telemetry is sent from a service, the location context is about the user that initiated the operation in the service.
    pub fn location_province(&mut self, location_province: impl Into<String>) -> &mut Self {
        self.location_province = Some(location_province.into());
        self
    }

    /// Sets: The city of the client device. If any of Country, Province, or City is specified, those values will be preferred over geolocation of the IP address field. Information in the location context fields is always about the end user. When telemetry is sent from a service, the location context is about the user that initiated the operation in the service.
    pub fn location_city(&mut self, location_city: impl Into<String>) -> &mut Self {
        self.location_city = Some(location_city.into());
        self
    }
    ...
    pub fn operation_name(&mut self, operation_name: impl Into<String>) -> &mut Self {
        self.operation_name = Some(operation_name.into());
        self
    }

    /// Sets: The unique identifier of the telemetry item's immediate parent.
    pub fn operation_parent_id(&mut self, operation_parent_id: impl Into<String>) -> &mut Self {
        self.operation_parent_id = Some(operation_parent_id.into());
        self
    }
    ...
    pub fn operation_synthetic_source(&mut self, operation_synthetic_source: impl Into<String>) -> &mut Self {
        self.operation_synthetic_source = Some(operation_synthetic_source.into());
        self
    }
    ...
    pub fn operation_correlation_vector(&mut self, operation_correlation_vector: impl Into<String>) -> &mut Self {
        self.operation_correlation_vector = Some(operation_correlation_vector.into());
        self
    }
    ...
    pub fn session_is_first(&mut self, session_is_first: impl Into<String>) -> &mut Self {
        self.session_is_first = Some(session_is_first.into());
        self
    }
    ...
    pub fn user_account_id(&mut self, user_account_id: impl Into<String>) -> &mut Self {
        self.user_account_id = Some(user_account_id.into());
        self
    }
    ...
    pub fn user_id(&mut self, user_id: impl Into<String>) -> &mut Self {
    ...
    pub fn user_auth_user_id(&mut self, user_auth_user_id: impl Into<String>) -> &mut Self {
        self.user_auth_user_id = Some(user_auth_user_id.into());
        self
    }

    /// Sets: Name of the role the application is a part of. Maps directly to the role name in azure.
    pub fn cloud_role(&mut self, cloud_role: impl Into<String>) -> &mut Self {
        self.cloud_role = Some(cloud_role.into());
        self
    }

    pub fn cloud_role_ver(&mut self, cloud_role_ver: impl Into<String>) -> &mut Self {
        self.cloud_role_ver = Some(cloud_role_ver.into());
        self
    }

    /// Sets: Name of the instance where the application is running. Computer name for on-premisis, instance name for Azure.
    pub fn cloud_role_instance(&mut self, cloud_role_instance: impl Into<String>) -> &mut Self {
        self.cloud_role_instance = Some(cloud_role_instance.into());
        self
    }

    pub fn cloud_location(&mut self, cloud_location: impl Into<String>) -> &mut Self {
        self.cloud_location = Some(cloud_location.into());
        self
    }
    ...
    pub fn internal_sdk_version(&mut self, internal_sdk_version: impl Into<String>) -> &mut Self {
        self.internal_sdk_version = Some(internal_sdk_version.into());
        self
    }
    ...
    pub fn internal_agent_version(&mut self, internal_agent_version: impl Into<String>) -> &mut Self {
        self.internal_agent_version = Some(internal_agent_version.into());
        self
    }

    /// Sets: This is the node name used for billing purposes. Use it to override the standard detection of nodes.
    pub fn internal_node_name(&mut self, internal_node_name: impl Into<String>) -> &mut Self {
        self.internal_node_name = Some(internal_node_name.into());
        self
    }
